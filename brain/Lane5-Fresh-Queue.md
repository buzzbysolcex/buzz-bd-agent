...
- **Hermetica** — Immunefi, live **2026-02-12 (~3.5mo, very fresh)**, $100K max, **Bitcoin-finance infra** (likely audit-light as new program; BTC-finance ties to our AIBTC focus). ← strongest audit-light-fresh lead.
- **Granite Protocol** — Immunefi, live 2025-02-26 (~15mo), $100K max, BTC-DeFi non-custodial. Less fresh.
