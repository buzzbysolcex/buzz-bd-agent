...
**NEXT ACTION (audit-light-fresh, confirmed-platform — applying the new gate):** candidates needing Step-1 platform+audit-count [VER] before dispatch: **Ethena USDtb/minting-converter** (row 7, Immunefi ~$1M, fresh 2025-26 modules, share-math PoC-able) · **fresh Solana restaking** (row 8, Jito/Sanctum/Kamino — DC-8 Anchor, less EVM-saturated, but verify bounty exists) · **Aave Umbrella** (stkToken slashing+cooldown — lets me REUSE the CANDIDATE-J Slash-Window⊂Claim-Delay compound; audit-heavy so research-first). Pick highest realizable-EV with confirmed platform at Step-1. **HOLD: Hyp-C = Immunefi slot 1 (21:40Z, untouched, operator-gated submit); all Gate-1 work parallel, NO submission conflict.**
