...
**Status:** SUBSTRATE-ARSENAL (Clarity arsenal v1.1, **3 anchors = Hermetica + Granite + Zest, all NEGATE**; lending sub-arsenal = 2 anchors). DC-3-Clarity, CANDIDATE-I-Clarity (+ tracked-var sub-check, now canonical), oracle-gating, as-contract, map-insert-replay, ERC4626-share-vs-index pricing-consistency, liquidation-3-guard checklist = active Clarity detector lenses. Clarinet still uninstalled (no Clarity CONFIRM yet to PoC). Authority: `hunts/2026-05-30-hermetica-immunefi-gate1.md` + `hunts/2026-05-30-granite-immunefi-gate1.md` + `hunts/2026-05-31-zest-v2-immunefi-gate1.md` (Ogie msgs 8042 + 8067/8069 autonomous EV-ordered loop).
