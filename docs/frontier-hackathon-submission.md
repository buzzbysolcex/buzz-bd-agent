...
**Ogie (@hidayahanka1)** — BD Lead & CEO, SolCex Exchange. 20+ years Executive Sous Chef, zero CS background, built entirely through conversational AI.
...
- Agent Skills: https://github.com/buzzbysolcex/agent-skills
...
- 25 intel sources
- 86+ CI/CD deploys
- $0/day LLM cost (Pro Max unlimited)
- 6-chain on-chain identity (ERC-8004, AgentProof, Virtuals ACP, Solana 8004, Colosseum, Moltbook)
- 210+ AIBTC check-ins
- ZHC readiness: 78%
...
- Autonomous deal closing pipeline
- Every CI/CD push, pipeline token, simulation, tweet = hackathon evidence
