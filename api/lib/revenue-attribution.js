...
const STAGE_PROBABILITIES = {
  discovered: 0.05, scanned: 0.10, scored: 0.15, prospect: 0.25,
  contacted: 0.40, negotiating: 0.60, approved: 0.85, listed: 1.0, rejected: 0
};
...
function calculateConversionProbability(tokenAddress, chain) {
  ...
  return { probability: Math.round(prob * 1000) / 1000, stage: record.current_stage };
}
...
module.exports = { trackAttribution, updateStage, recordAgentTouch, calculateConversionProbability, getAttributionReport, getTopPerformingSources };
