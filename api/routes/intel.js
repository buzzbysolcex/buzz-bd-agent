...
const INTEL_SOURCES = [
  ...
  },
  {
    ...
    layer: "L1",
    endpoint: "api.dexscreener.com/token-boosts",
    env_key: "DEXSCREENER_BASE_URL",
  },
  {
    id: "cmc",
  ...
  },
  {
    ...
    name: "Allium",
    layer: "L2",
    endpoint: "api.allium.so",
    env_key: "ALLIUM_API_KEY",
  },
  {
    id: "grok",
    name: "Grok x_search",
  ...
  },
  {
    ...
    name: "Serper",
    layer: "L3",
    endpoint: "google.serper.dev",
    env_key: "SERPER_API_KEY",
  },
  {
    id: "atv",
    name: "ATV Web3 Identity",
    layer: "L3",
    endpoint: "api.web3identity.com",
    env_key: "ATV_API_URL",
  },
  {
    id: "firecrawl",
  ...
  },
  {
    ...
    name: "Nansen x402",
    layer: "L5",
    endpoint: "x402 micropayment",
    env_key: "NANSEN_X402_ENABLED",
  },
  {
    id: "twitter",
    name: "X API v2",
  ...
  },
  {
    ...
    env_key: "BANKR_API_KEY",
  },
  {
    id: "moltbook",
    name: "Moltbook",
    layer: "Social",
    endpoint: "moltbook.com",
    env_key: "MOLTBOOK_API_KEY",
  },
  {
    id: "bnbchain",
    name: "BNB Chain MCP",
  ...
  },
  {
    ...
    layer: "L1",
    type: "MCP",
    endpoint: "api.financialdatasets.ai",
...
// ─── TELEGRAM INTEL INTAKE (Option D: MCP plugin relay) ─────

/**
 * POST /api/v1/intel/telegram/ingest
 * Accepts messages relayed from MCP telegram plugin.
 * The MCP plugin consumes getUpdates (destructive read),
 * so pollIntakeChannel() can't compete. Instead, messages
 * are POSTed here after the MCP plugin delivers them.
 *
 * Body: { chat_id, message_id, date, text }
 */
if (require("../lib/feature-flags").feature("TELEGRAM_CHANNEL_INTEL")) {
  const {
  ...
  router.get("/telegram/stats", (req, res) => {
