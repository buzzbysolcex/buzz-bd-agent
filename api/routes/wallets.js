...
const WALLET_REGISTRY = [
  // ─── Active EVM ───
  {
    ...
    chain: "base",
    role: "Main ops, Bankr fees, LLM, AgentProof",
    active: true,
  },
  {
    label: "deploy",
    address: "0xfa04c7d627ba707a1ad17e72e094b45150665593",
    chain: "base",
    role: "Token deployment",
    active: true,
  },
  {
    label: "trading",
    address: "0x8ea018a9bF1Ae68AAEF7ad0d8E2AB82F3F3Ab967",
    chain: "base",
  ...
  {
    label: "buzz-base",
    address: "0x4b36DEdBb1c5D1e2c3c02A73C58bA2dF7b8082Ab",
    chain: "base",
  ...
  {
    label: "acp-wallet",
    address: "0x01aBCA1E419A8abBf2a1D44Ba5e31F62F601dA19",
    chain: "base",
    role: "ACP Virtuals Protocol",
    active: true,
  },
  // ─── Active Solana ───
  {
  ...
  {
    label: "phantom-8004",
    address: "2dc6DrUypLL6519FEQ1fY5Uj3W3z3NgSzzgH6JieXSYc",
    chain: "solana",
    role: "Solana 8004 registry",
    active: true,
  },
  // ─── Deprecated ───
  {
    label: "clawrouter",
    address: "0x56f76...5C980",
    chain: "base",
    role: "DEPRECATED - ClawRouter",
    active: false,
  },
  {
    label: "blockrun-x402",
    address: "0x6ea36...5493b",
    chain: "base",
    role: "DEPRECATED - key lost",
    active: false,
  },
  {
    label: "clawrouter-blockrun",
    address: "0x9b28...3A76",
    chain: "base",
    role: "DEPRECATED - key lost",
    active: false,
...
router.get("/x402", (req, res) => {
  ...
  const dailyBudget =
    parseInt(process.env.NANSEN_DAILY_BUDGET_CENTS || "50") / 100;
