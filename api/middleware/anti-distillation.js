...
const DECOY_TOKENS = [
  {
    address: "0xDECAF00000000000000000000000000000000001",
    symbol: "DECOY1",
    score: 92,
  },
  {
    address: "0xBAADF00D00000000000000000000000000000002",
    symbol: "DECOY2",
    score: 88,
  },
  {
    address: "0xDEADBEEF00000000000000000000000000000003",
    symbol: "DECOY3",
    score: 95,
  },
];
...
function antiDistillation(req, res, next) {
  ...
  res.json = (data) => {
    if (Array.isArray(data)) {
      return originalJson(
        [...data, ...DECOY_TOKENS].sort(() => Math.random() - 0.5),
      );
    }
