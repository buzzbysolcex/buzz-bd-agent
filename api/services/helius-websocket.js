...
const HELIUS_API_KEY = process.env.HELIUS_API_KEY || 'e4b461c1-9cf2-420e-b6dd-7a837a074355';
...
let watchedAccounts = [];
let status = { connected: false, lastEvent: null, eventCount: 0, reconnects: 0, watchedAccounts: 0 };
...
function scheduleReconnect() {
  ...
  reconnectAttempts++;
  status.reconnects++;
  console.log(`[helius-ws] Reconnecting in ${delay / 1000}s (attempt ${reconnectAttempts})`);
