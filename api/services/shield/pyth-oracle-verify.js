...
async function verifyPriceIntegrity(symbol, claimedPrice) {
  ...
  // Calculate deviation
  const deviation = Math.abs(claimedPrice - pythData.price) / pythData.price * 100;
...
module.exports = { verifyPriceIntegrity, fetchPythPrice, getSupportedSymbols, PYTH_FEEDS };
