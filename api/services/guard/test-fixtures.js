...
const BLOCK_EXAMPLE = {
  decision: 'BLOCK',
  reasoning: 'Institutional policy blocked non-self value transfer. | reasonCode=INSTITUTIONAL_VALUE_TRANSFER_BLOCKED | riskLevel=CRITICAL',
  consequence: 'This request has been blocked by constitutional execution policy.',
  ...
  receipt: {
    ...
    overrideUsed: false,
    txFingerprint: 'bc711cb810bb6e7f7759ee307510417085617d0ab019480a15c76a7b84ddb810',
...
const WARN_EXAMPLE = {
  decision: 'WARN',
  reasoning: 'First-time interaction with destination address. | reasonCode=FIRST_TIME_DESTINATION | riskLevel=HIGH',
...
const ALLOW_EXAMPLE = {
  decision: 'ALLOW',
  reasoning: 'Self-transfer detected | reasonCode=SELF_TRANSFER | riskLevel=LOW',
