...
function updateSignalStatus({ signal_id, status, publisher_feedback }) {
  ...
  if (status === 'approved') {
    emit('signal-tracker', EVENT_TYPES.SIGNAL_APPROVED, { signal_id, feedback: publisher_feedback });
  } else if (status === 'rejected') {
    emit('signal-tracker', EVENT_TYPES.SIGNAL_REJECTED, { signal_id, feedback: publisher_feedback });
  }
