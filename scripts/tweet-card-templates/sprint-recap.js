...
const METRICS = [
  { label: "Tokens Scored", value: "256", color: "#00ff41" },
  { label: "HOT Qualified", value: "0 (honest)", color: "#ff6b6b" },
  { label: "Signal Revenue", value: "$125+", color: "#00ff41" },
  { label: "Signal Streak", value: "7 days", color: "#00ccff" },
  { label: "Contracts Deployed", value: "1 (Base)", color: "#00ff41" },
  { label: "Intel Sources", value: "29", color: "#00ccff" },
  { label: "ARIA Endpoints", value: "5 live", color: "#00ff41" },
